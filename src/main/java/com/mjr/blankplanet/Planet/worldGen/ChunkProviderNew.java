...
public abstract class ChunkProviderNew extends ChunkProviderGenerate
{
    ...
    // DO NOT CHANGE
    public final int MID_HEIGHT = this.getSeaLevel();
    public static final int CHUNK_SIZE_X = 16;
    public static final int CHUNK_SIZE_Y = 256;
    public static final int CHUNK_SIZE_Z = 16;
    public static final double MAIN_FEATURE_FILTER_MOD = 4;
    public static final double LARGE_FEATURE_FILTER_MOD = 8;
    public static final double SMALL_FEATURE_FILTER_MOD = 8;
