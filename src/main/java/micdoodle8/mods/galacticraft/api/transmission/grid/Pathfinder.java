...
/**
 * A class that allows flexible pathfinding for different positions. Compared to AStar pathfinding, this version is faster but does not calculated the most optimal path.
 *
 * @author Calclavia
 */
