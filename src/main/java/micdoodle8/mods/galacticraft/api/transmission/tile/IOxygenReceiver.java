...
public interface IOxygenReceiver extends IConnector {
	...
	/**
	 * Adds oxygen reception to a tile entity. Returns the quantity of oxygen that was accepted. This should always return 0 if the block cannot receive oxygen.
	 *
	 * @param from
	...
	/**
	 * Adds oxygen provision to a block. Returns the quantity of oxygen provided. This should always return 0 if the tile entity cannot provide oxygen.
	 *
	 * @param from
