...
public interface IElectrical extends IConnector {
	/**
	 * Adds electricity to an block. Returns the quantity of electricity that was accepted. This should always return 0 if the block cannot be externally charged.
	 *
	 * @param from
	...
	/**
	 * Adds electricity to an block. Returns the ElectricityPack, the electricity provided. This should always return null if the block cannot be externally discharged.
	 *
	 * @param from
