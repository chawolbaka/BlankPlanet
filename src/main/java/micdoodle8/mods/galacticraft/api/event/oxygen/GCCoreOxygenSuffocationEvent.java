...
public abstract class GCCoreOxygenSuffocationEvent extends LivingEvent {
	 ...
	 * <p/>
	 * Set the event as canceled to stop the living entity from suffocating IF THE PRE EVENT IS CANCELED, THE "WARNING: OXYGEN SETUP INVALID!" HUD MESSAGE WILL NOT BE SHOWN
	 */
	@Cancelable
