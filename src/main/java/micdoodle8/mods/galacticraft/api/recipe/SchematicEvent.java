...
/**
 * These events are used internally to perform actions when Galacticraft is installed, without needing to include unnecessary classes. There is no need to subscribe to these events.
 */
