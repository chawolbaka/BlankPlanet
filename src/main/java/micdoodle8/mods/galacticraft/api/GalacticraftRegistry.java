...
public class GalacticraftRegistry {
	 ...
	 *
	 * @param clazz
	 *            the world provider class that you wish to customize teleportation for
	 * @param type
	 *            an ITeleportType-implemented class that will be used for the provided world type
	 */
	 ...
	 *
	 * @param tier
	 *            Tier of dungeon chest to add loot to. For example Moon is 1 and Mars is 2
	 * @param loot
	...
	/***
	 * Now returns a boolean to indicate whether registration of the WorldProvider type was successful. (If it failed, you should probably set the CelestialBody as unreachable.)
	 * 
	 * @param id
	 * @param provider
	 * @param keepLoaded
	...
	/**
	 * You should now use GalacticraftRegistry.registerProvider(int id, Class<? extends WorldProvider> provider, boolean keepLoaded, int defaultID) which returns a boolean indicating if the Provider was registered OK.
	 * 
	 * @param id
	 * @param provider
	 * @param keepLoaded
	 ...
	 * 
	 * @param screen
	 *            The IGameScreen to be registered
