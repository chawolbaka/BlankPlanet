...
public interface IFuelable {
	 ...
	 *
	 * @param fluid
	 *            The fluid to add. Be sure to check if the correct fluid is being loaded before adding it.
	 * @param doDrain
	 *            Whether or not fluid should actually be added, or is just a test.
